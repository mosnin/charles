  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        <p className={SECTION_LABEL}>How should Charles address you?</p>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          >
            How you like to work with Charles
          </Label>
          <Textarea
      ...
      <div className="space-y-3">
        <p className={SECTION_LABEL}>Special instructions for Charles</p>
        <div className="space-y-1.5">
          <Label
          ...
          <Textarea
            ...
            onBlur={() => saveOnBlur(profile)}
            placeholder="Any specific way you want Charles to behave — tone, format, topics to avoid..."
          />
          <p className={cn(BODY_MUTED, 'text-xs')}>
            This is fed directly into Charles&apos;s context.
          </p>
        </div>
      </div>
    </div>
